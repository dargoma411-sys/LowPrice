...
module.exports = async (req, res) => {
  ...
  // Проверка: если есть русские буквы — предупреждаем
  if (/[а-яё]/i.test(query)) {
    return res.json({
      products: [],
      hint: 'Поиск работает только с английскими названиями. Попробуй написать запрос на английском, например «Steam Balance» вместо «стим баланс».',
    });
  }
